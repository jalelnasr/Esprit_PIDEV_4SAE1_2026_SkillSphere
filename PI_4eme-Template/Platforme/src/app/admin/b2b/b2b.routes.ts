...
export const B2B_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'missions', canActivate: [b2bRoleGuard], data: { allowedRoles: ['ADMIN','RH','RH_ENTREPRISE','FORMATEUR'] }, loadComponent: () => import('./missions/mission-list/mission-list.component').then(m => m.MissionListComponent) },
      { path: 'missions/new', canActivate: [b2bRoleGuard], data: { allowedRoles: ['ADMIN','RH','RH_ENTREPRISE','FORMATEUR'] }, loadComponent: () => import('./missions/mission-form/mission-form.component').then(m => m.MissionFormComponent) },
      { path: 'missions/:id/edit', canActivate: [b2bRoleGuard], data: { allowedRoles: ['ADMIN','RH','RH_ENTREPRISE','FORMATEUR'] }, loadComponent: () => import('./missions/mission-form/mission-form.component').then(m => m.MissionFormComponent) },
      { path: 'missions/:id/candidates', canActivate: [b2bRoleGuard], data: { allowedRoles: ['ADMIN','RH','RH_ENTREPRISE','FORMATEUR'] }, loadComponent: () => import('./pages/mission-candidates.component').then(m => m.MissionCandidatesComponent) },
