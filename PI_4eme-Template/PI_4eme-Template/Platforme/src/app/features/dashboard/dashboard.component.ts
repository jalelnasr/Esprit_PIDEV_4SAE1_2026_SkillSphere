...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    // ✅ DO NOT call me() because your AuthService doesn't have it.
    // Use restoreSession() which calls GET /api/users/me if token exists.
    this.authService.restoreSession().subscribe({
      next: (u: BackendUser | null) => console.log('SESSION USER:', u),
