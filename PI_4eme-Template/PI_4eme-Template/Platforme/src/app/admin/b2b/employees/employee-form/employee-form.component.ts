      ...
      <div class="form-card">
        <form (ngSubmit)="onSubmit()" #empForm="ngForm">
          ...
          <ng-container *ngIf="!isEdit">
            ...
            <div class="form-group">
              ...
              <select [(ngModel)]="newUser.role" name="role" required class="form-control">
                ...
                <option value="FORMATEUR">Trainer (FORMATEUR)</option>
              ...
              <small class="hint" *ngIf="userRole === 'MANAGER'">
                As a Manager, you can create Learners and Trainers for your department
              </small>
              <small class="hint" *ngIf="userRole === 'RH_ENTREPRISE'">
                As HR, you can create Learners, Trainers and Managers
              </small>
            </div>
          </ng-container>
          ...
          <div class="form-group">
            ...
            <select [(ngModel)]="form.managerId" name="managerId" class="form-control">
              <option [ngValue]="null">— None —</option>
              <option *ngFor="let m of companyManagers" [value]="m.idUser">
