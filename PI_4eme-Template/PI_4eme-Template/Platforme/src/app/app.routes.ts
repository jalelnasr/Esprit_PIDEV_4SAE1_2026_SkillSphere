...
export const routes: Routes = [
  ...
  // 🔍 Route de test pour diagnostiquer les problèmes API
  { path: 'test-api', loadComponent: () => import('./test-api.component').then(m => m.TestApiComponent) },
  
  // 🔍 Route de test pour competition-detail
  { path: 'test-competition/:id', loadComponent: () => import('./test-competition-detail.component').then(m => m.TestCompetitionDetailComponent) },
