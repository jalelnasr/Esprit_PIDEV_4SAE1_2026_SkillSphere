...
export class SidebarComponent implements OnInit {
  ...
  allMenuItems: MenuItem[] = [
...

    {
      ...
      subItems: [
        { label: '🏠 Corporate Home', route: '/corporate-home' },
        { label: '📦 Training Catalog', route: '/catalog' },
        { label: '💼 Job Offers', route: '/careers' },
        { label: '🚀 Freelance Missions', route: '/freelance' },
        { label: '🏗️ My Company', route: '/my-company' },
        { label: '⚙️ Management Portal', route: '/corporate' }
      ]
    },
